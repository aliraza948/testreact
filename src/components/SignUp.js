  ...
  render() {
    return (
      <section className='flex justify-center mt-52'><div className="w-96 py-7 rounded-md shadow-lg shadow-zinc-400 justify-center flex">
        ...
        <div className="justify-center flex"><div className="text-2xl">Sign Up</div></div>
        ...
        <div className="flex bg-gradient-to-tr from-purple-400 to-purple-700 via-purple-400 pb-1 rounded">
            <input type="text" placeholder='Username' className='placeholder:text-center w-48  focus:outline-none'/>
            </div>
            <div className="flex bg-gradient-to-tr from-purple-400 to-purple-700 via-purple-400 pb-1 rounded">
            <input type="text" placeholder='Email' className='placeholder:text-center w-48  focus:outline-none'/>
            </div>
            <div className="flex bg-gradient-to-tr from-purple-400 to-purple-700 via-purple-400 pb-1 rounded">
            ...
            <div>I have already an Account <a href="" className='text-blue-500 cursor-pointer hover:underline'> Sign Up</a></div>
        </div>
        </div></section>
